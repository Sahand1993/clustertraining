...
for i in range(10):
    print()
    modelPath = "finetune_nq/finetune_nq_{}/model_bs".format(i + 1) + str(BATCH_SIZE) + "_lr" + str(LEARNING_RATE)

    try:
        os.mkdir("finetune_nq")
    except:
        pass
    try:
        os.mkdir("finetune_nq/finetune_nq_{}".format(i + 1))
        os.mkdir(modelPath)
    ...
    with tf.compat.v1.Session() as sess:
        ...
        trainingSet = NaturalQuestionsFileIterator( # TODO: If this doesn't give you the result you want, try changing the iterator so that we sample from the whole data.csv file, like in the other iterators
