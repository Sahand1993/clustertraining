...
NO_OF_INDICES = 247481

tf.compat.v1.disable_eager_execution()

# tf Graph Input
x_q = tf.compat.v1.placeholder("float32", name="x_q", shape=[None, NO_OF_INDICES])

x_p = tf.compat.v1.placeholder("float32", name="x_p", shape=[None, NO_OF_INDICES])

x_n1 = tf.compat.v1.placeholder("float32", name="x_n1", shape=[None, NO_OF_INDICES])

x_n2 = tf.compat.v1.placeholder("float32", name="x_n2", shape=[None, NO_OF_INDICES])

x_n3 = tf.compat.v1.placeholder("float32", name="x_n3", shape=[None, NO_OF_INDICES])

x_n4 = tf.compat.v1.placeholder("float32", name="x_n4", shape=[None, NO_OF_INDICES])
