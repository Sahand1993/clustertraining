...
x_n5 = tf.compat.v1.placeholder("float32", name="x_n5", shape=[None, NO_OF_TRIGRAMS])

x_n6 = tf.compat.v1.placeholder("float32", name="x_n6", shape=[None, NO_OF_TRIGRAMS])

x_n7 = tf.compat.v1.placeholder("float32", name="x_n7", shape=[None, NO_OF_TRIGRAMS])

x_n8 = tf.compat.v1.placeholder("float32", name="x_n8", shape=[None, NO_OF_TRIGRAMS])

x_n9 = tf.compat.v1.placeholder("float32", name="x_n9", shape=[None, NO_OF_TRIGRAMS])

x_n10 = tf.compat.v1.placeholder("float32", name="x_n10", shape=[None, NO_OF_TRIGRAMS])
...
l2_n5 = tf.compat.v1.tanh(tf.compat.v1.matmul(x_n5, W_2) + b_2)
l2_n6 = tf.compat.v1.tanh(tf.compat.v1.matmul(x_n6, W_2) + b_2)
l2_n7 = tf.compat.v1.tanh(tf.compat.v1.matmul(x_n7, W_2) + b_2)
l2_n8 = tf.compat.v1.tanh(tf.compat.v1.matmul(x_n8, W_2) + b_2)
l2_n9 = tf.compat.v1.tanh(tf.compat.v1.matmul(x_n9, W_2) + b_2)
l2_n10 = tf.compat.v1.tanh(tf.compat.v1.matmul(x_n10, W_2) + b_2)
...
l3_n5 = tf.compat.v1.tanh(tf.compat.v1.matmul(l2_n5, W_3) + b_3)
l3_n6 = tf.compat.v1.tanh(tf.compat.v1.matmul(l2_n6, W_3) + b_3)
l3_n7 = tf.compat.v1.tanh(tf.compat.v1.matmul(l2_n7, W_3) + b_3)
l3_n8 = tf.compat.v1.tanh(tf.compat.v1.matmul(l2_n8, W_3) + b_3)
l3_n9 = tf.compat.v1.tanh(tf.compat.v1.matmul(l2_n9, W_3) + b_3)
l3_n10 = tf.compat.v1.tanh(tf.compat.v1.matmul(l2_n10, W_3) + b_3)
...
y_n5 = tf.compat.v1.tanh(tf.compat.v1.matmul(l3_n5, W_4) + b_4)
y_n6 = tf.compat.v1.tanh(tf.compat.v1.matmul(l3_n6, W_4) + b_4)
y_n7 = tf.compat.v1.tanh(tf.compat.v1.matmul(l3_n7, W_4) + b_4)
y_n8 = tf.compat.v1.tanh(tf.compat.v1.matmul(l3_n8, W_4) + b_4)
y_n9 = tf.compat.v1.tanh(tf.compat.v1.matmul(l3_n9, W_4) + b_4)
y_n10 = tf.compat.v1.tanh(tf.compat.v1.matmul(l3_n10, W_4) + b_4)
...
r_n6 = cosine_similarity(y_q, y_n6)
r_n7 = cosine_similarity(y_q, y_n7)
r_n8 = cosine_similarity(y_q, y_n8)
r_n9 = cosine_similarity(y_q, y_n9)
r_n10 = cosine_similarity(y_q, y_n10)


sum_r = tf.compat.v1.exp(r_p) + tf.compat.v1.exp(r_n1) + tf.compat.v1.exp(r_n2) + tf.compat.v1.exp(r_n3) + tf.compat.v1.exp(r_n4) + tf.compat.v1.exp(r_n5) + tf.compat.v1.exp(r_n6) + tf.compat.v1.exp(r_n7) + tf.compat.v1.exp(r_n8) + tf.compat.v1.exp(r_n9) + tf.compat.v1.exp(r_n10)
...
prob_n5 = tf.compat.v1.math.divide(tf.compat.v1.exp(r_n5), sum_r)
prob_n6 = tf.compat.v1.math.divide(tf.compat.v1.exp(r_n6), sum_r)
prob_n7 = tf.compat.v1.math.divide(tf.compat.v1.exp(r_n7), sum_r)
prob_n8 = tf.compat.v1.math.divide(tf.compat.v1.exp(r_n8), sum_r)
prob_n9 = tf.compat.v1.math.divide(tf.compat.v1.exp(r_n9), sum_r)
prob_n10 = tf.compat.v1.math.divide(tf.compat.v1.exp(r_n10), sum_r)
