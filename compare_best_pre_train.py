...
modelPath = "pretrain/pretrain_smallnq_ngram_5/model_bs" + str(BATCH_SIZE) + "_lr" + str(LEARNING_RATE)
try:
    os.mkdir("pretrain/pretrain_smallnq_ngram_5") # TODO: Change in notebook
     # TODO: Change in notebook
    os.mkdir(modelPath)
...
with tf.compat.v1.Session() as sess:
  ...
  quoraValidationSet = QuoraFileIterator(
      "datasets_smallnq/quora/total.csv",
      "datasets_smallnq/quora/val.csv",
      batch_size=BATCH_SIZE,
      no_of_irrelevant_samples=4,
      encodingType="NGRAM",
      dense=DENSE
  ...
  rcv1ValidationSet = ReutersFileIterator(
      "datasets_smallnq/rcv1/total.json",
      "datasets_smallnq/rcv1/val.json",
      batch_size=BATCH_SIZE,
      no_of_irrelevant_samples=4,
      encodingType="NGRAM",
      dense=DENSE)
